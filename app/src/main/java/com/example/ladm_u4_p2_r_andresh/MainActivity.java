package com.example.ladm_u4_p2_r_andresh;
...
public class MainActivity extends AppCompatActivity {
    ...
    Button buscar,enviar,dispositivos,estado;
    ListView listView;
    TextView msg_box;
    EditText mensaje;
    ...
    private static final String APP_NAME = "ChatBT";
    private static final UUID MY_UUID=UUID.fromString("f55b8666-39a1-46e9-a438-7feb2732f99b");
        ...
        public boolean handleMessage(@NonNull Message msg) {
            switch (msg.what){
                ...
                case STATE_CONNECTION_FAILED:
                    estado.setText("Conexión Fallida");
                    break;
